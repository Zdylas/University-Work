...
class CarHeapQueue():
    ...
    def __init__(self, num_children=2, start_data=None):
    ...
    def __repr__(self):
        return f"CarHeapQueue([{', '.join(repr(car) for car in self._data)}])"
...
class EditableCarHeapQueue(CarHeapQueue):
    ...
    def __init__(self, num_children=2, start_data=None):
        ...
        super().__init__(num_children, start_data)
    ...
    def __repr__(self):
        return f"EditableCarHeapQueue([{', '.join(repr(car) for car in self._data)}])"
